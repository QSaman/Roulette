...
\begin{document}
	...
	\begin{equation*}
		...
		\end{split}
	\end{equation*} \\
	Now let's calculate on average how many rounds it takes. Note that if we win, we stop playing. We continue playing if we lose or there is a tie. So we have:
	\begin{equation*}
		e(n, d) = \begin{cases}
	...
	\begin{equation*}
		...
		\end{cases}
	\end{equation*}	
	For example $e(3150, 5) = 1.98$:
	\begin{equation*}
		\begin{split}
			e(3150, 50) &= \frac{1}{1 - (1 - p) \times q} + (1 - \frac{p}{1 - (1 - p) \times q}) \times e(3000, 200) = 1.98 \\
			e(3000, 200) &= \frac{1}{1 - (1 - p) \times q} + (1 - \frac{p}{1 - (1 - p) \times q}) \times e(2400, 800) = 1.87 \\
			e(2400, 800) &= \frac{1}{1 - (1 - p) \times q} + (1 - \frac{p}{1 - (1 - p) \times q}) \times e(0, 3200) = 1.62 \\
			e(0, 3200) &= 0
		\end{split}
	\end{equation*}
