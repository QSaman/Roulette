...
\begin{document}
	...
	\par As an example, let's assume we have 3 chips with the value of \$$\frac{1}{3}$. We bet one of them on black, the other on an even number and the other on a number greater than 18. Note that all of our bets are in the same round. we assume $r = \frac{p}{n}$. The expected value is:
	\begin{equation*}
		\begin{split}
			E &= \underbrace{\frac{3}{3} \times r^3}_{\text{3 wins}} \\
			  &+ \underbrace{(\frac{2}{3} - \frac{1}{3}) \times r^2 \times (1 - r)}_{\text{2 wins and 1 loss}} \\
			  &+ \underbrace{(\frac{1}{3} - \frac{2}{3}) \times r \times (1 - r)^2}_{\text{1 win and 2 losses}} \\
			  &+ \underbrace{(-\frac{3}{3}) \times (1 - r)^3}_{\text{3 losses}} \\
			  &= -0.023
		\end{split}
	\end{equation*}
	We assumed we played in Canada ($n = 37$).
	\section{Chance of winning}
	In each round the change of winning in Canada is $\frac{18}{37} \simeq 49\%$ and the chance of loss is $\frac{19}{37} \simeq 51\%$. In the US the chance of winning is $\frac{18}{38} \simeq 47\%$ and the change of loss is $\frac{20}{38} \simeq 53\%$.
