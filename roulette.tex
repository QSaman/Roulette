...
\begin{document}
	...
	In each round the change of winning in Canada is $\frac{18}{37}$ and the chance of loss is $\frac{19}{37}$. In the US the chance of winning is $\frac{18}{38}$ and the change of loss is $\frac{20}{38}$.
	\par Please refer to this \href{https://www.youtube.com/watch?v=56iFMY8QW2k}{MIT lecture}.
